...
namespace Comercial.Clases
{
    class classDatos
    {
        MySqlConnection miCOnexion = new MySqlConnection("Server=72.61.47.240;Database=loDeOva;User ID=remoto;Password=0315061;SslMode=None;AllowPublicKeyRetrieval=True;");
