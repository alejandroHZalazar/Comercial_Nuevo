...
{
    public partial class frmPedidosParaEditar : Form
    {
        ...
        public frmPedidosParaEditar ()
        {
            InitializeComponent();
        }

        public frmPedidosParaEditar(frmPedidos frmPedidos)
        {
            InitializeComponent();
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            dgvOrden.Rows.Clear();
            dgvProductos.Rows.Clear();
            filtro = " and fecha between '" + dtpDesde.Value.Year + "-" + dtpDesde.Value.Month + "-" + dtpDesde.Value.Day + "' and '" + dtpHasta.Value.Year + "-" + dtpHasta.Value.Month + "-" + dtpHasta.Value.Day + " 23:59:59'";
            if (cboVendedores.SelectedValue.ToString() != "0")
            {
                filtro += "and p.fk_vendedor = " + cboVendedores.SelectedValue.ToString();
            }
            dgvOrden.DataSource = instPed.traerCabeceraParaEditar(filtro);
        ...
        private void frmPedidosParaEditar_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (dgvOrden .RowCount > 0)
            {
                instPed.elimnarPedido(int.Parse (dgvOrden.CurrentRow.Cells["id"].Value.ToString()));
