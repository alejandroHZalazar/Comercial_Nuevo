...
BEGIN
select linea, fk_pedido,d.fk_producto,codBarras as 'Cod_Barras',codProveedor as 'Cod_Proveedor',Descripcion,s.cantidad as 'Stock',Precio,d.Cantidad,Subtotal,precioOrig,d.costo
